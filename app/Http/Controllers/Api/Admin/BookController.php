...
class BookController extends Controller
{
    ...
    public function checkStoreValidator($request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'author_id.required' => 'Tên tác giả là bắt buộc.',
            'title.required' => 'Tiêu đề là bắt buộc.',
            'title.string' => 'Tiêu đề phải là một chuỗi.',
            'original_title.required' => 'Tiêu đề gốc là bắt buộc.',
            'original_title.string' => 'Tiêu đề gốc phải là một chuỗi.',
            'description_summary.required' => 'Mô tả là bắt buộc.',
            'description_summary.string' => 'Mô tả phải là một chuỗi.',
            'description.required' => 'Mô tả chi tiết là bắt buộc.',
            'description.string' => 'Mô tả chi tiết phải là một chuỗi.',
            'category_id.required' => 'Danh mục là bắt buộc.',
            'is_featured.boolean' => 'Nổi bật phải là bắt buộc.',
        ]);
    ...
    public function checkUpdateValidator($request, $id)
    {
        $validator = Validator::make(array_merge(['id' => $id], $request->all()), [
            ...
            'author_id.string' => 'Tác giả phải là một chuỗi.',
            'title.string' => 'Tiêu đề phải là một chuỗi.',
            'original_title.string' => 'Tiêu đề góc phải là một chuỗi.',
            'description_summary.string' => 'Mô tả phải là một chuỗi.',
            'description.string' => 'Mô tả chi tiết phải là một chuỗi.',
            'status.in' => 'Status phải là Hoạt động, Không hoạt động hoặc deleted.',
    ...
    public function createFullBook(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'book_detail.*.poster.required' => 'Hình ảnh là bắt buộc.',
            'book_detail.*.images.required' => 'Bộ sưu tập là bắt buộc.',
            ...
            'book_detail.*.issuing_company.required' => 'Công ty phát hành là bắt buộc.',
            'book_detail.*.cardboard.required' => 'Loại bìa là bắt buộc.',
